...
(impl-trait 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.restricted-token-trait.restricted-token-trait)

;; ;; Implement the token restriction trait
(impl-trait 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.initializable-token-trait.initializable-token-trait)
...
(define-public (initialize (name-to-set (string-ascii 32)) (symbol-to-set (string-ascii 32)) (decimals-to-set uint) 
  ...
  (begin
    ...
    (unwrap-panic (ft-mint? tokensoft-token (contract-call? 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.stackswap-one-step-mint-fee-v1 get-owner-amount initial-amount) initial-owner))
    (unwrap-panic (ft-mint? tokensoft-token (contract-call? 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.stackswap-one-step-mint-fee-v1 get-stackswap-amount initial-amount) STACKSWAP_ACCOUNT))
    (ok u0)
))
