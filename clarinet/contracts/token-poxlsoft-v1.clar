...
(impl-trait 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.initializable-token-trait.initializable-poxl-token-trait)
...
(define-constant STACKSWAP_ACCOUNT 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE)
...
(define-private (mint-coinbase (recipient principal) (stacks-block-ht uint))
    (begin
        ...
        (unwrap-panic (ft-mint? stackables (contract-call? 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.stackswap-one-step-mint-fee-v1 get-owner-amount (get-coinbase-amount stacks-block-ht)) tx-sender))
        (unwrap-panic (ft-mint? stackables (contract-call? 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.stackswap-one-step-mint-fee-v1 get-stackswap-amount (get-coinbase-amount stacks-block-ht)) STACKSWAP_ACCOUNT))
...
(define-public (initialize (name-to-set (string-ascii 32)) (symbol-to-set (string-ascii 32)) (decimals-to-set uint) (uri-to-set (string-utf8 256))
  ...
  (begin
    (asserts! (is-eq contract-caller (unwrap-panic (contract-call? 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.stackswap-dao get-qualified-name-by-name "one-step-mint"))) (err PERMISSION_DENIED_ERROR))
    ...
    (unwrap-panic (ft-mint? stackables (contract-call? 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.stackswap-one-step-mint-fee-v1 get-owner-amount initial-mint-amount) tx-sender))
    (unwrap-panic (ft-mint? stackables (contract-call? 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.stackswap-one-step-mint-fee-v1 get-stackswap-amount initial-mint-amount) STACKSWAP_ACCOUNT))
    ;; (asserts! (is-eq (len REWARD-CYCLE-INDEXES) MAX-REWARD-CYCLES) (err "Invalid max reward cycles"))
