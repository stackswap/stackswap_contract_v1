...
(use-trait initable-sip010 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.initializable-token-trait.initializable-token-trait)
(use-trait initable-poxl 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.initializable-token-trait.initializable-poxl-token-trait)
(use-trait initable-liquidity 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.initializable-token-trait.initializable-liquidity-token-trait)
...
(define-public (create-pair-new-sip10-token-with-stx (token-y-trait <sip-010-token>) (token-liquidity-trait <liquidity-token>) (pair-name (string-ascii 32)) (x uint) (y uint) (token-y-init-trait <initable-sip010>) (token-liquidity-soft <initable-liquidity>)  (name-to-set (string-ascii 32)) (symbol-to-set (string-ascii 32)) (decimals-to-set uint) (uri-to-set (string-utf8 256)) (website-to-set (string-utf8 256))  (initial-amount uint) )
  (begin
    ...
    (unwrap-panic (create-pair-new-liquidity-token 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.wstx-token token-y-trait token-liquidity-trait pair-name x y token-liquidity-soft))
...
(define-public (create-pair-new-liquidity-token (token-x-trait <sip-010-token>) (token-y-trait <sip-010-token>)  (token-liquidity <liquidity-token>) (pair-name (string-ascii 32)) (x uint) (y uint) (token-liquidity-soft <initable-liquidity>) )
  (begin
    ...
    (unwrap-panic (contract-call? 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.stackswap-swap-v1 create-pair token-x-trait token-y-trait token-liquidity pair-name x y))
